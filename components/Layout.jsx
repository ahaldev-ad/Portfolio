...
const Layout = ({ children, profile }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-hidden bg-zinc-950">
      ...
      {/* Refined Dynamic Background Effects - Corner Glows matching reference image */}
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none select-none opacity-40">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[500px] h-[500px] bg-indigo-900/5 rounded-full blur-[100px] animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-[-5%] left-[10%] w-[700px] h-[700px] bg-zinc-900/10 rounded-full blur-[140px] animate-blob animation-delay-4000"></div>
      </div>

      {/* Navigation - Transparent & Floating style */}
